...
export const PAGE_SEO = {
  "/": {
    title: "أكاديمية طلاقة | تعلَّم الإنجليزي مع مدربين سعوديين محترفين",
    description:
      "أكاديمية طلاقة — دورات إنجليزي أونلاين بمجموعات صغيرة (7 طلاب) مع مدربين سعوديين. متابعة يومية، حصص فردية، تقييم بالذكاء الاصطناعي. باقات تبدأ من 500 ريال.",
  ...
  "/level-test": {
    title: "اختبار تحديد المستوى في الإنجليزي — أكاديمية طلاقة",
    description:
      "اختبار تكيّفي مجاني يحدد مستواك في الإنجليزي بدقة (CEFR من Pre-A1 إلى C1) في عشر دقائق: قواعد، مفردات، استيعاب، استماع، وكتابة — مع تقرير مفصّل لمهاراتك وخطوتك الجاية.",
    ogDescription:
      "عشر دقائق تعطيك مستواك الحقيقي في الإنجليزي، وتقرير يوضح وين قوتك ووين تحتاج شغل.",
  },

  "/start": {
    title: "ابدأ الإنجليزي مع طلاقة — باقات تبدأ من ٥٠٠ ر.س | أكاديمية طلاقة",
    description:
      "ابدأ رحلتك مع أكاديمية طلاقة: مجموعات صغيرة (٧ طلاب)، متابعة يومية مع مدربين سعوديين، ومنصة ذكية. باقات من ٥٠٠ ر.س شهرياً. أول محادثة مجانية — بدون التزام.",
    ogTitle: "ابدأ الإنجليزي مع طلاقة — باقات تبدأ من ٥٠٠ ر.س",
    ogDescription:
