// TOUR PORT: vendored from fluentia-lms src/components/grammar/exercise-types/TransformQuestion.jsx (origin/main 3396e97e).
...
export default function TransformQuestion({ item, answer, onAnswer, exerciseType }) {
  ...
  const handleSubmit = (e) => {
    ...
    const result = guardFalseAccept(gradeAnswer(input.trim(), {
      ...
      type: exerciseType === 'make_question' ? 'make_question' : 'transform',
