...
export default function FinalCTASection() {
  ...
  const copy = status === "open"
    ? {
        ...
        headline: "التسجيل مفتوح الآن.",
        sub: `مقاعد محدودة لكل مجموعة. تواصل مع المدرّب لمعرفة الباقة الأنسب لك.`,
    ...
    ? {
        ...
        sub: `فترة التسجيل القادمة قريباً. تواصل من الآن لنخبرك يوم الافتتاح.`,
